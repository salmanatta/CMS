        ...
        <div class="card">
            <div class="card-header bg-light">
                <div class="d-flex" style="align-items: center">
                    ...
                    <a href="{{url('showTicketLog')}}" ><i class="icon-info-sign ps-1"></i></a>
                </div>
            </div>
            <div class="card-body">
                ...
                @else
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control" id="editor1" {{isset($tickets)? 'readonly':'' }} name="ComplainDetails" >{!! isset($tickets) ? $tickets->details : '' !!}</textarea>
