<nav id="sidebar" class="sidebar">
          ...
          <span class="align-middle me-3">PIC - CMS</span>
			...
			</div></div></div></div><div class="simplebar-placeholder" style="width: auto; height: 1261px;"></div></div><div class="simplebar-track simplebar-horizontal" style="visibility: hidden;"><div class="simplebar-scrollbar" style="width: 0px; display: none;"></div></div><div class="simplebar-track simplebar-vertical" style="visibility: visible;"><div class="simplebar-scrollbar" style="height: 744px; transform: translate3d(0px, 0px, 0px); display: block;"></div></div></div>
		</nav>